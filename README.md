...
[![techs](https://skills.syvixor.com/api/icons?i=flutter,dart,firebase,python,fastapi,mongodb,postgresql,amazonwebservices,json,JSON schema,jwt,OpenAPI,oauth,websocket,rest,graphql,docker,kubernetes,bash&perline=8&radius=40)](https://github.com/syvixor/skills-icons)
