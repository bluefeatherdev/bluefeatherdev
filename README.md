...
[![techs](https://skills.syvixor.com/api/icons?i=flutter,dart,firebase,python,fastapi,mongodb,postgresql,amazonwebservices,json,jsonschema,jwt,openapi,oauth,websocket,rest,graphql,docker,kubernetes,bash&perline=8&radius=40)](https://github.com/syvixor/skills-icons)
